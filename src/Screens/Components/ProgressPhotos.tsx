...
interface ProgressPhotosProps {
    initialPhoto?: ImageSourcePropType;
    latestPhoto?: ImageSourcePropType;
    style?: any;
}
            ...
            <View style={styles.photosContainer}>
                <View style={styles.photoSection}>
                    ...
                    <View style={styles.imageContainer}>
                        {initialPhoto ? (
                            <Image source={initialPhoto} style={styles.image} resizeMode="cover" />
                        ) : (
                ...
                <View style={styles.photoSection}>
                    ...
                    <View style={styles.imageContainer}>
                        {latestPhoto ? (
                            <Image source={latestPhoto} style={styles.image} resizeMode="cover" />
                        ) : (
                            <View style={styles.placeholderContainer}>
                                <Text style={styles.placeholderText}>No Photo</Text>
                            </View>
